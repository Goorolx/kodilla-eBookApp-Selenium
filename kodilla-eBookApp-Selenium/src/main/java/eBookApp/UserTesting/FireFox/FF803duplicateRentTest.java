...
public class FF803duplicateRentTest {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElement(By.xpath("//input[@name='customer-name']")).sendKeys("Duplicate");
        ...
        yearSelect.click();
        Thread.sleep(2000);
        WebElement monthSelect = driver.findElement(By.xpath("//span[@class='cell month selected' and contains(text(), 'June')]"));
        monthSelect.click();
        Thread.sleep(2000);
        WebElement daySelect = driver.findElement(By.xpath("//span[@class='cell day' and contains(text(), '18')]"));
        daySelect.click();
        Thread.sleep(2000);
